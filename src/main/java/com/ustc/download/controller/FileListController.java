...
public class FileListController {
    ...
    public CommonResult<PageInfo<FileListBean>> findList(PageInfo<FileListBean> pi, String pid, String orderfield, String ordertype, HttpServletRequest request) {
        PageInfo<FileListBean> pageList = fileService.findPageList(pi.getPage(), pi.getLimit(), "test", pid, "all", orderfield, ordertype);
